...
/*zoznam premenn�ch
id - id zariadenia
eled - elektrick� energia - impulzy - denn� pr�d
elen - elektrick� energia - impulzy - no�n� pr�d
pln - zemn� plyn - impulzy
vod - voda - impulzy
...
//
//    $query = "INSERT INTO devices (id_zakaznik, eled, elen, pln, vod, tepvn, data_all) VALUES ('".$vstup["id"]."',".$vstup["eled"].",".$vstup["elen"].",".$vstup["pln"].",".$vstup["vod"].",".$vstup["tepvn"].", '".$queryString."')";

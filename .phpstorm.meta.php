...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'logging.channels.device_measurement.driver' => 'string',
            'logging.channels.device_measurement.path' => 'string',
            'logging.channels.device_measurement.level' => 'string',
            'logging.channels.device_measurement.replace_placeholders' => 'boolean',
            'mail.default' => 'string',
            ...
            'masterConfig.error_notification_user' => 'integer',
            'masterConfig.master_user_id' => 'integer',
            'masterConfig.cron_user_id' => 'integer',
            ...
            'filament-log-manager.navigation_group' => 'boolean',
            'filament-log-manager.navigation_icon' => 'string',
            'filament-log-manager.logs_directory' => 'string',
            'filament-log-manager.allow_delete' => 'boolean',
            'filament-log-manager.allow_download' => 'boolean',
            'filament-log-manager.page_class' => 'string',
            'filament-apex-charts.chart_options' => 'string',
...
'app.aliases.Session','app.aliases.Storage','app.aliases.URL','app.aliases.Validator','app.aliases.View',
'app.aliases.Str','app.aliases.Roles','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.disks.s3.throw','filesystems.links./var/www/html/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'logging.channels.emergency.path','logging.channels.device_measurement.driver','logging.channels.device_measurement.path','logging.channels.device_measurement.level','logging.channels.device_measurement.replace_placeholders',
...
'mail.markdown.paths','masterConfig.error_notification_user','masterConfig.master_user_id','masterConfig.cron_user_id','permission.models.permission',
...
'sanctum.middleware.validate_csrf_token','sentry.dsn','sentry.release','sentry.environment','sentry.sample_rate',
...
'filament.default_filesystem_disk','filament.assets_path','filament.cache_path','filament.livewire_loading_delay','filament-log-manager.navigation_group',
'filament-log-manager.navigation_icon','filament-log-manager.logs_directory','filament-log-manager.allow_delete','filament-log-manager.allow_download','filament-log-manager.page_class',
'filament-apex-charts.chart_options','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'livewire.navigate.show_progress_bar','livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','one-time-operations.directory',
...
'filament.admin.auth.password-reset.reset','filament.admin.auth.logout','filament.admin.home','filament.admin.pages.consumption','filament.admin.pages.test',
'filament.admin.pages.logs','filament.admin.resources.calculations.index','filament.admin.resources.devices.index','filament.admin.resources.measurements.index','filament.admin.resources.roles.index',
'filament.admin.resources.users.index','filament.admin.resources.users.view','sanctum.csrf-cookie','livewire.update','livewire.upload-file','livewire.preview-file',
'login',);
        registerArgumentsSet('views', 
'components.card.card','components.card.icon','components.card.text','components.includes.footer','components.layouts.app',
'components.layouts.base','components.nav.nav','components.nav.nav-link','errors.401','errors.402',
'errors.403','errors.404','errors.419','errors.429','errors.500',
'errors.503','errors.layout','errors.minimal','filament.pages.consumption-page','filament.pages.test-page',
'livewire.contakt-form','livewire.counter','mail.contact-us-mail','pages.alarm','pages.contact',
'pages.home','pages.meranie_spotreby','test','welcome','filament-actions::badge-action',
...
'filament-actions::icon-button-group','filament-actions::link-action','filament-actions::link-group','filament-actions::select-action','filament-apex-charts::widgets.apex-chart-widget',
'filament-apex-charts::widgets.components.chart','filament-apex-charts::widgets.components.filter-form','filament-apex-charts::widgets.components.header','filament-daterangepicker-filter::date-range-picker','filament-forms::component-container',
...
'filament-infolists::components.split','filament-infolists::components.tabs','filament-infolists::components.tabs.tab','filament-infolists::components.text-entry','filament-log-manager::pages.logs',
...
'filament-tables::table.sorting.fields.direction.options.desc','filament-log-manager::translations.navigation_label','filament-log-manager::translations.navigation_group','filament-log-manager::translations.title','filament-log-manager::translations.search_placeholder',
'filament-log-manager::translations.no_logs','filament-log-manager::translations.delete','filament-log-manager::translations.download','filament-log-manager::translations.no_such_file','filament-log-manager::translations.file_too_large',
'filament-log-manager::translations.modal_delete_heading','filament-log-manager::translations.modal_delete_subheading','filament-log-manager::translations.modal_delete_action_cancel','filament-log-manager::translations.modal_delete_action_confirm','filament-daterangepicker-filter::message.period',
'filament-daterangepicker-filter::message.su','filament-daterangepicker-filter::message.mo','filament-daterangepicker-filter::message.tu','filament-daterangepicker-filter::message.we','filament-daterangepicker-filter::message.th',
'filament-daterangepicker-filter::message.fr','filament-daterangepicker-filter::message.sa','filament-daterangepicker-filter::message.custom','filament-daterangepicker-filter::message.apply','filament-daterangepicker-filter::message.cancel',
'filament-daterangepicker-filter::message.from','filament-daterangepicker-filter::message.to','filament-daterangepicker-filter::message.january','filament-daterangepicker-filter::message.february','filament-daterangepicker-filter::message.march',
'filament-daterangepicker-filter::message.april','filament-daterangepicker-filter::message.may','filament-daterangepicker-filter::message.june','filament-daterangepicker-filter::message.july','filament-daterangepicker-filter::message.august',
'filament-daterangepicker-filter::message.september','filament-daterangepicker-filter::message.october','filament-daterangepicker-filter::message.november','filament-daterangepicker-filter::message.december','filament-daterangepicker-filter::message.today',
'filament-daterangepicker-filter::message.yesterday','filament-daterangepicker-filter::message.last_7_days','filament-daterangepicker-filter::message.last_30_days','filament-daterangepicker-filter::message.this_month','filament-daterangepicker-filter::message.last_month',
'filament-daterangepicker-filter::message.this_year','filament-daterangepicker-filter::message.last_year','filament-daterangepicker-filter::message.clear','filament-daterangepicker-filter::message.weekLabel',);

<x-layouts.base>
    ...
    {{--            <x-card.text>--}}
    {{--                <p class="font-bold text-3xl xl:text-5xl mb-4">FOTOVOLTIKA SO ŠTÁTNOU DOTÁCIOU</p>--}}
    ...
    {{--                </x-card.text>--}}
    {{--            </x-card.card>--}}
    {{--            <x-card.card class="cursor-pointer" onclick="window.location.href='/kamery'">--}}
    {{--                <x-card.icon>--}}
    {{--                    <path stroke-linecap="round" stroke-linejoin="round"--}}
    ...
    <div class="max-w-7xl mx-auto px-4 py-6 bg-[#FCF7F7]">
        <div class="relative w-full rounded-xl">
            <img class="w-full h-full object-cover object-top-[70%]" alt="header"
                 src="{{ asset('storage/home/main_frame.png') }}">

            <div class="hidden sm:block absolute bottom-0 right-0 text-white text-right p-4 md:p-8 lg:p-12 xl:p-16 w-full sm:max-w-[70%]">
                <h1 class="text-xl md:text-3xl xl:text-4xl font-bold leading-tight mb-2 2xl:mb-6">
                    {{ __('Inovatívne riešenia pre inteligentnejšiu budúcnosť') }}
                </h1>

                <h5 class="text-base sm:text-xl font-light text-white">
                    {{ __('Špecializujeme sa na fotovoltiku, kamerové systémy, alarmy a revízie elektroinštalácií pre vašu domácnosť aj firmu.') }}
                </h5>
            </div>
        </div>
        ...
        <div class="hidden md:block max-w-7xl w-full py-0 sm:py-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 justify-center">
                <x-service-card icon="sun" title="Fotovoltika"
                                description="Využite silu slnka s našimi efektívnymi solárnymi riešeniami." />

                <x-service-card icon="camera" title="Kamerové systémy"
                                description="Zvýšte bezpečnosť pomocou našich moderných kamerových systémov." />
        ...
        <div class="max-w-7xl w-full py-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 justify-center">
                <a href="{{ url('/photovoltaicSystems') }}">
                    <x-image-service-card
                        image="storage/home/solar.png"
                        title="Solárne panely"
                        description="Vysokoúčinné solárne panely pre domácnosti aj firmy." />
                </a>

                <a href="{{ url('/kamery') }}">
                    <x-image-service-card
                        image="storage/home/camera.png"
                        title="Kamerové systémy"
                        description="Pokročilé sledovacie systémy s možnosťou vzdialeného prístupu." />
                </a>
        ...
        <div class="justify-center text-center py-20">
            ...
            <div class="text-black font-normal text-base mb-8">
                <p>
                    Kontaktujte nás ešte dnes a získajte nezáväznú konzultáciu a cenovú ponuku.
                </p>
            </div>
            <a href="{{ route('kontakt') }}">
                <button class="inline-block bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-3 rounded-full transition duration-200 text-center">
                    Kontaktujte nás
                </button>
            </a>
        </div>

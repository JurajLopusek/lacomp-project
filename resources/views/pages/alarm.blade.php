<x-layouts.base>
    <div class="grid grid-cols-2 grid-rows-1 mx-6 mt-6 gap-8">
        <div class="flex flex-col max-w-sm rounded overflow-hidden shadow-lg p-4 justify-self-end">
            <div class="px-6 py-4">
                <div class="font-bold text-xl mb-4">JABLOTRON</div>
        ...
        <div class="flex flex-col max-w-sm rounded overflow-hidden shadow-lg p-4">
            <div class="px-6 py-4">

<x-layouts.base>
    <div class="">
        <div class="h-full flex items-center justify-center pt-12 h-10 pb-8">
            ...
            <div>
                <ul class="md:mb-0">
                    <li class="flex">
                        ...
                        <div class="ml-4 mb-4">
                            <h3 class="mb-2 text-lg font-medium leading-6 text-black">Adresa
                            </h3>
                    ...
                    <li class="flex">
                        ...
                        <div class="ml-4 mb-4">
                            <h3 class="mb-2 text-lg font-medium leading-6 text-black">Kontakt
                            </h3>
                    ...
                    <li class="flex">
                        ...
                        <div class="ml-4 mb-4">
                            <h3 class="mb-2 text-lg font-medium leading-6 text-black">Pracovná doba</h3>

            ...
            <div class="w-full lg:w-1/2">
                <ul class="space-y-6">
                    ...
                    <li class="flex items-start">
                        ...
                        <div class="ml-4">
                            <h3 class="mb-2 text-lg font-medium text-black dark:text-gray-200">Kontakt</h3>
                    ...
                    <li class="flex items-start">
                        ...
                        <div class="ml-4">
                            <h3 class="mb-2 text-lg font-medium text-black dark:text-gray-200">Pracovná doba</h3>

<footer class="bg-gray-700">
    <div class="h-full flex justify-center mt-6 sm:mt-12">
        <ul class="grid grid-cols-1 sm:grid-cols-3 sm:mx-10">
            <li class="flex">
                <div class="flex h-10 w-10 items-center justify-center rounded bg-[#d60000] text-gray-50">
